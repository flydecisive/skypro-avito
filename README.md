...
1. Скачать файл backend'a по [ссылке](https://drive.google.com/file/d/1pFE-NRANTsWmQwTyURjHXuECMmoKCFjO/view) и развернуть его в Docker.
   1.1. Скачайте архив и разархивируйте его.
   1.2. Через терминал перейдите в разархивированную папку.
   1.3. Запустите в терминале команду: __docker-compose -f docker-compose-backend.yaml up -d__
